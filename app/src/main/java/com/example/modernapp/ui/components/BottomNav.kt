...
//    listItems :List<BottomNavItemData>
) {
    BottomAppBar(
        ...
        Row(
            ...
            BottomNavItem(
                ...
                title = "Home",
                isSelected = selectedTap == "Home",
                onClick = { onTabSelected("Home") }
            )
            BottomNavItem(
                iconRes = R.drawable.bottom_btn2,
                title = "Wallet",
                isSelected = selectedTap == "Wallet",
            ...
            BottomNavItem(
                ...
                title = "Profile",
                isSelected = selectedTap == "Profile",
                onClick = { onTabSelected("Profile") }
            )
            BottomNavItem(
                iconRes = R.drawable.bottom_btn4,
                title = "Settings",
                isSelected = selectedTap == "Settings",
...
fun BottomNavigationBarPreview() {
    BottomNavigationBar(selectedTap = "Home", onTabSelected = {})
}
